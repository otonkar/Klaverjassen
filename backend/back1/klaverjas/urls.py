...
urlpatterns = [
    ...
    path('matches/<str:matchID>/', views.MatchRetrieveUpdate.as_view(), name='match_retrieve_update'),
    ...
    path('games/<int:pk>/', views.GameRetrieveUpdate.as_view(), name='game_retreive_update'),
