...
class Match(models.Model):
    ...
    date_created       = models.DateTimeField(default=datetime.now(), blank=False, null=False)
...
class Leg(models.Model):
    ...
    date_completed      = models.DateTimeField(default=datetime.now(), blank=False, null=False)
